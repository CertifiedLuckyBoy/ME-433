...
## ME433 HW12 modifications

- Uses standard CAN identifier `0x433`.
- Sends the 16-byte message `KARL-HW12-CAN!!!`.
- Pressing the NUCLEO USER button transmits the message.
- The virtual COM port prints startup, transmitted, and received messages at
  115200 baud.
- A valid received message turns on LED1.
- Two NUCLEO-C092RC boards are connected through CANH, CANL, and GND, with JP9
  installed on one board for bus termination.
